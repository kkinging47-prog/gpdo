...
export default async function AdminDashboard() {
  ...
  return <main className="admin-shell"><AdminSidebar /><section className="admin-main">
    ...
    <div className="admin-status-banner"><strong>Media, Slideshow, Events and Programs are enabled.</strong><span>You can now manage the organization’s main public content without editing GitHub.</span></div>
