...
export default async function AdminDashboard() {
  ...
  return <main className="admin-shell"><AdminSidebar /><section className="admin-main">
    ...
    <div className="admin-status-banner"><strong>Media, Slideshow, Events, Programs and News are enabled.</strong><span>You can now manage the organization’s major public content without editing GitHub.</span></div>
