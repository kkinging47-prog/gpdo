...
export default function Footer() {
  ...
  return <footer><div className="container"><div className="footer-grid">
    ...
    <div className="footer-col"><h4>Organization</h4><Link href="/about">About GPDO</Link><Link href="/programs">Our Work</Link><Link href="/gallery">Gallery</Link><Link href="/events">Events</Link><Link href="/news">News & Stories</Link><Link href="/about#governance">Our Approach</Link></div>
